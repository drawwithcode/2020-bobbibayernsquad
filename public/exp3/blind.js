...
function preload(){
  ...
  //Load map
  labyrinth.push(loadImage("assets/Images/Blind/labyrinth_0.png"));
  labyrinth.push(loadImage("assets/Images/Blind/labyrinth_1.png"));
  labyrinth.push(loadImage("assets/Images/Blind/labyrinth_2.png"));
  labyrinth.push(loadImage("assets/Images/Blind/labyrinth_3.png"));
...
function draw() {
  ...
  if (preLobby) {
    ...
    fill(255);
    textFont(latin);
    text("waiting for an assistant to join", windowWidth/2, windowHeight/5*4);
    pop();
  ...
  victoryCheck(){
    if (this.t > this.pause) {
      if (77<=this.sprites_i<=82 && this.sprites_j==0) {
        ...
        window.open("finale_blind.html", "_self");
      }
    }
  }
